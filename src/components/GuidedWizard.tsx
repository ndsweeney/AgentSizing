  ...
  if (!tree) {
    return (
      <div className="text-center p-8">
        <p>No guided questions available for this dimension.</p>
        <button onClick={onExitGuidedMode} className="text-blue-600 underline mt-4">
    ...
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="text-sm font-medium text-gray-500">
          Step {currentStep + 1} of {DIMENSIONS.length}: <span className="text-gray-900 font-bold">{currentDimension.label}</span>
        </div>
        <button 
          ...
          >
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
              >
          ...
          >
            ...
            <div className="grid gap-4">
              {question?.answers.map((answer) => (
                ...
                >
                  <div className="font-medium text-gray-900 group-hover:text-blue-700 text-lg mb-1">
                    {answer.text}
                  </div>
                  {answer.explanation && (
