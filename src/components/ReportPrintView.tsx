...
export function ReportPrintView() {
  ...
  return (
    <div className="print-container max-w-[210mm] mx-auto bg-white p-[20mm] min-h-screen">
      ...
      {/* Footer */}
      <footer className="mt-12 pt-4 border-t border-gray-200 text-center text-xs text-gray-500 print:hidden">
      ...
      <div className="fixed bottom-8 right-8 print:hidden">
        <button 
          ...
          className="bg-blue-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-blue-700 font-medium flex items-center gap-2 transition-colors"
        >
