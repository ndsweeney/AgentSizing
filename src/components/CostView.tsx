...
export function CostView() {
  ...
  const AssumptionInput = ({ 
    ...
    <div className="mb-4">
      <div className="flex justify-between text-sm mb-1">
        ...
        <span className="font-medium text-gray-900">{format(activeAssumptions[field])}</span>
      </div>
      <input
        type="range"
        min={min}
  ...
  const BenefitInput = ({ 
    ...
    <div className="mb-4">
      <div className="flex justify-between text-sm mb-1">
        <span className="text-gray-700">{label}</span>
        <span className="font-medium text-gray-900">{format(activeBenefitAssumptions[field] || 0)}</span>
      </div>
      <input
        type="range"
        min={min}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 bg-gray-50 rounded-lg hover:bg-gray-100 border border-gray-200"
          >
        ...
        {showSettings && (
          <div className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200 animate-in fade-in slide-in-from-top-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Usage</h4>
              ...
              <div>
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Licensing & Azure</h4>
              ...
              <div>
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Implementation</h4>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div>
                  <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Efficiency</h4>
                ...
                <div>
                  <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Value</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
            <div className="text-sm text-blue-600 font-medium mb-1">One-Time Implementation</div>
            <div className="text-2xl font-bold text-blue-900">{formatCurrency(costs.totalOneTime)}</div>
            <div className="text-xs text-blue-500 mt-1">
              Est. {costs.sprintsEstimate} sprints ({costs.sprintsEstimate * 2} weeks)
            </div>
          </div>
          <div className="p-4 bg-green-50 rounded-lg border border-green-100">
            <div className="text-sm text-green-600 font-medium mb-1">Monthly Run Cost</div>
            <div className="text-2xl font-bold text-green-900">{formatCurrency(costs.totalMonthly)}</div>
            <div className="text-xs text-green-500 mt-1">
              Licensing + Azure + Support
            </div>
          </div>
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
            <div className="text-sm text-purple-600 font-medium mb-1">First Year Total</div>
            <div className="text-2xl font-bold text-purple-900">{formatCurrency(costs.totalAnnual)}</div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">One-Time</th>
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Monthly</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={cn(
                      ...
                      item.category === 'Licensing' ? "bg-yellow-100 text-yellow-800" :
                      item.category === 'Infrastructure' ? "bg-blue-100 text-blue-800" :
                      item.category === 'Implementation' ? "bg-purple-100 text-purple-800" :
              ...
              <tr className="bg-gray-50 font-bold">
                ...
                <td className="px-6 py-4 text-right text-gray-900">{formatCurrency(costs.totalOneTime)}</td>
                <td className="px-6 py-4 text-right text-gray-900">{formatCurrency(costs.totalMonthly)}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="text-2xl font-bold text-gray-900">{formatCurrency(roi.annualTotalBenefit)}</div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className={cn("text-2xl font-bold", roi.netBenefit >= 0 ? "text-green-600" : "text-red-600")}>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className={cn("text-2xl font-bold", roi.roiPercent >= 0 ? "text-green-600" : "text-red-600")}>
        ...
        <div className="relative h-12 bg-gray-100 rounded-full overflow-hidden flex">
          <div 
            className="h-full bg-red-400 flex items-center justify-center text-white text-xs font-bold transition-all duration-500"
            style={{ width: `${Math.min(100, (roi.annualCost / (roi.annualCost + roi.annualTotalBenefit)) * 100)}%` }}
          >
            Cost
          </div>
          <div 
            className="h-full bg-green-500 flex items-center justify-center text-white text-xs font-bold transition-all duration-500"
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Total Benefit</th>
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Net Benefit</th>
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">ROI</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              <tr className="hover:bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">1 Year</td>
                <td className="px-6 py-4 text-sm text-right text-gray-500">{formatCurrency(roi.oneYear.totalCost)}</td>
                <td className="px-6 py-4 text-sm text-right text-green-600">{formatCurrency(roi.oneYear.totalBenefit)}</td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.oneYear.netBenefit >= 0 ? "text-green-600" : "text-red-600")}>
                  {formatCurrency(roi.oneYear.netBenefit)}
                </td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.oneYear.roiPercent >= 0 ? "text-green-600" : "text-red-600")}>
                  {roi.oneYear.roiPercent.toFixed(0)}%
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">3 Year</td>
                <td className="px-6 py-4 text-sm text-right text-gray-500">{formatCurrency(roi.threeYear.totalCost)}</td>
                <td className="px-6 py-4 text-sm text-right text-green-600">{formatCurrency(roi.threeYear.totalBenefit)}</td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.threeYear.netBenefit >= 0 ? "text-green-600" : "text-red-600")}>
                  {formatCurrency(roi.threeYear.netBenefit)}
                </td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.threeYear.roiPercent >= 0 ? "text-green-600" : "text-red-600")}>
                  {roi.threeYear.roiPercent.toFixed(0)}%
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">5 Year</td>
                <td className="px-6 py-4 text-sm text-right text-gray-500">{formatCurrency(roi.fiveYear.totalCost)}</td>
                <td className="px-6 py-4 text-sm text-right text-green-600">{formatCurrency(roi.fiveYear.totalBenefit)}</td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.fiveYear.netBenefit >= 0 ? "text-green-600" : "text-red-600")}>
                  {formatCurrency(roi.fiveYear.netBenefit)}
                </td>
                <td className={cn("px-6 py-4 text-sm text-right font-medium", roi.fiveYear.roiPercent >= 0 ? "text-green-600" : "text-red-600")}>
